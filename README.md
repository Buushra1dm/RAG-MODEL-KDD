...
---
ممتاز جدًا 👏
إضافة صور نتائج الموديل في الـ **README.md** يعطي مشروعك طابعًا احترافيًا جدًا خصوصًا إذا بتقدّمينه لشركة أو في GitHub Portfolio.
إليك الطريقة المثالية لكتابة قسم الصور داخل README بشكل منسق ومناسب لأسلوبك في المشروع 👇
...
### 🧠 Example 1 — KDD Career Query

**User Query:**

> “Are there any open Python developer positions in Sabhan?”
<img width="2842" height="1040" alt="sql" src="https://github.com/user-attachments/assets/7f2bad20-ba8b-4e05-aa62-795cdc327161" />
...
<img width="2842" height="1040" alt="sql" src="https://github.com/user-attachments/assets/0a63ca5b-eee4-4d48-b498-6d5c9cb5ded3" />

---

### 🍦 Example 2 — KDD Product Query
...
**RAG Response:**
The system fetched product entries from the KDD e-shop, applied FAISS retrieval and reranking, and displayed the grounded answer.

![Product Result](images/product_result.png)

---

### 💬 Example 3 — Domain Restriction Logic

**User Query:**

> “Who is the CEO of Kudo?”

**RAG Response:**
“This question is outside the KDD domain. I can only answer about KDD products and careers.”

<img width="2858" height="966" alt="ceo" src="https://github.com/user-attachments/assets/1133e870-a179-4d6d-af24-79addc6f54d6" />

---

### 📊 Example 4 — Smart Knowledge Search Page

The following image shows the interactive **Smart Knowledge Search** interface powered by FastAPI and the RAG pipeline.

![Smart Search UI](images/smart_search.png)
